...
"""
#NOTE: implementing this as in the VectorizeMe ppt
#NOTE:the indicator function return TSI, momentum, bbp, priceSMA
import pandas as pd
import numpy as np
    ...
    for row in forcasts.itertuples():
        ...
        if row_dict['JPM']>0:
            if current_share==0:
                ...
                #forcasts[row_dict['Index'],'Buy/Sell']=1
            ...
            if current_share==0:
                ...
                forcasts.loc[row_dict['Index'],'Shares']=-2000
                #forcasts[row_dict['Index'],'Buy/Sell']=-1
    #vectorizing way to add the Sell/Buy column

    #results=forcasts['Shares','Buy/Sell']
...
def test(symbol,sd,ed,opening,title=''):
    syb=symbol
    start=sd
    end=ed
    openings=opening
...
if __name__=="__main__":
    ...
    print 'Part 4'
    test('JPM',dt.datetime(2010,1,1),dt.datetime(2011,12,31),100000,title='part4')
